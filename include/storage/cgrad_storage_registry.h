...
/* ============================================================================
 * Global Storage Registry API
 *
 * All functions operate on a single global registry instance.
 * No registry pointer parameter is needed.
 * ============================================================================ */
 ...
 * @return CGRAD_ERR_STORAGE_REGISTRY_NOT_EMPTY if the registry is not empty, otherwise frees the registry.
 */
void cgrad_storage_registry_free(void);

/**
 * @brief Check if the global storage registry is empty.
