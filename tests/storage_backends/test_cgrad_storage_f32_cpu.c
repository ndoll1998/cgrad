...
static void test_cgrad_tensor_f32_gemm_simple(void **state) {
    (void)state;
...
static void test_cgrad_tensor_f32_gemm_batched(void **state) {
    (void)state;
    cgrad_storage_f32_cpu a, b, c;
...
static void test_cgrad_tensor_f32_gemm_with_transpose(void **state) {
    (void)state;
    cgrad_storage_f32_cpu a, b, c;
    uint32_t shapeA[] = {1, 1, 2, 3};
    uint32_t shapeB[] = {1, 1, 3, 2};
...
static void test_cgrad_tensor_f32_tensor_add(void **state) {
    (void)state;
    cgrad_storage_f32_cpu a, b, c;
...
int run_cgrad_storage_f32_cpu_tests(void) {
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(test_cgrad_tensor_f32_gemm_simple),
        cmocka_unit_test(test_cgrad_tensor_f32_gemm_batched),
        cmocka_unit_test(test_cgrad_tensor_f32_gemm_with_transpose),
        cmocka_unit_test(test_cgrad_tensor_f32_tensor_add),
        cmocka_unit_test(test_cgrad_tensor_f32_add_with_transposed_inputs),
        cmocka_unit_test(test_cgrad_tensor_f32_gemm_with_transposed_inputs),
    };
    return _cmocka_run_group_tests("cgrad_storage_f32_cpu", tests, sizeof(tests)/sizeof(tests[0]), NULL, NULL);
}
