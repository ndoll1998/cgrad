...
static void test_tensor_init(void **state) {
    (void) state;
...
static void test_tensor_fill(void **state) {
    (void) state;
...
static void test_tensor_sub(void **state) {
    (void) state;
...
static void test_tensor_gemm(void **state) {
    (void) state;
...
static void test_tensor_transpose(void **state) {
    (void) state;
...
static void test_tensor_reshape(void **state) {
    (void) state;
...
static void test_tensor_reduce_sum(void **state) {
    (void) state;
...
int main(void) {
    const struct CMUnitTest tests[] = {
        cmocka_unit_test_teardown(test_tensor_init, teardown_test),
        cmocka_unit_test_teardown(test_tensor_fill, teardown_test),
        cmocka_unit_test_teardown(test_tensor_add, teardown_test),
        cmocka_unit_test_teardown(test_tensor_sub, teardown_test),
        cmocka_unit_test_teardown(test_tensor_gemm, teardown_test),
        cmocka_unit_test_teardown(test_tensor_transpose, teardown_test),
        cmocka_unit_test_teardown(test_tensor_reshape, teardown_test),
        cmocka_unit_test_teardown(test_tensor_reduce_sum, teardown_test),
...
#else
int test_cgrad_tensor_main(void) {
    const struct CMUnitTest tests[] = {
        cmocka_unit_test_teardown(test_tensor_init, teardown_test),
        cmocka_unit_test_teardown(test_tensor_fill, teardown_test),
        cmocka_unit_test_teardown(test_tensor_add, teardown_test),
