...
static void test_cgrad_storage_register_root_and_find(void **state) {
    ...
    extern cgrad_storage_registry global_storage_registry;
    cgrad_storage_registry_entry* reg_entry = NULL;
    HASH_FIND(hh, global_storage_registry.storage_map, tensor->uuid, sizeof(uuid_t), reg_entry);
...
static void test_cgrad_storage_register_child_and_bucket_sharing(void **state) {
    ...
    HASH_FIND(hh, global_storage_registry.storage_map, root->uuid, sizeof(uuid_t), root_entry);
    HASH_FIND(hh, global_storage_registry.storage_map, child->uuid, sizeof(uuid_t), child_entry);
    ...
    assert_int_equal(rc, CGRAD_SUCCESS);
    assert_int_equal(cgrad_storage_registry_get_bucket_size(root), 1);
